...
public class EspecieServiceMock implements EspecieService {
	...
	static {
		Especie bohr = new Especie("Bohrmon", TipoBicho.AGUA);
		bohr.setAltura(180);
		bohr.setPeso(75);
		...
		Especie schrodinger = new Especie("Schrodingermon", TipoBicho.AGUA);
		...
		Especie tesla = new Especie("Teslamon", TipoBicho.ELECTRICIDAD);
		tesla.setAltura(150);
		tesla.setPeso(55);
